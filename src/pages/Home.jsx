      ...
      <section className="section projects-preview" id="projects-preview" ref={projectsRef}>
        <div className="container reveal">
          ...
          <div className="projects-grid">
            <Link to="/projects/completed/whitehall-birdhouse-cleanup" className="project-card" id="project-card-completed">
              ...
              <div className="project-card-body">
                <span className="project-status completed">★ Our First Project</span>
